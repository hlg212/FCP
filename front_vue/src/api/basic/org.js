...
var serviceUrl = "basic/";
var moduleUrl ={
  findPage: serviceUrl + "org/findPage",
  getById: serviceUrl + "org/getById",
  save: serviceUrl + "org/save",
  update: serviceUrl + "org/updateAndReturn",
  deleteById: serviceUrl + "org/deleteById",
  //exportPage: serviceUrl + "app/exportPage",
  exportPage: serviceUrl + "org/exportPage",
  importSave: serviceUrl + "org/import/upload/save"
}
