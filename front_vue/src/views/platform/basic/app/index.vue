<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="应用代码" prop="code" sortable align="center" width="120" >
        <template slot-scope="{row}">
          <span>{{ row.code }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="首页地址" prop="indexUrl" align="center" width="150" >
        <template slot-scope="{row}">
          <span>{{ row.indexUrl }}</span>
        </template>
      </el-table-column>
      <el-table-column label="认证地址" prop="loginUrl"  align="center" width="150" >
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="应用代码" prop="code">
          <el-input :disabled='temp.disabled' v-model="temp.code" placeholder="输入应用代码" />
        </el-form-item>
        ...
        <el-form-item label="首页地址" prop="indexUrl">
          <el-input :disabled='temp.disabled' v-model="temp.indexUrl" placeholder="导航应用首页地址"/>
        </el-form-item>
        <el-form-item label="认证地址" prop="loginUrl">
          <el-input :disabled='temp.disabled' v-model="temp.loginUrl" placeholder="如果没有认证,跳转到该地址登陆"/>
        </el-form-item>
...
import { findPage, getById, save, update,exportPage,importSave, deleteById } from '@/api/basic/app'
import waves from '@/directive/waves' // waves directive
import { parseTime } from '@/utils'
import Pagination from '@/components/Pagination' // secondary package based on el-pagination

// const appTypeOptions = [
//   { key: 'web', display_name: '前端系统' },
//   { key: 'service', display_name: '后端服务' }
// ]
const appTypeOptions = DictHelper.getDicts("basic","APP_TYPE");
const appTypeKeyValue = DictHelper.getDictsMap("basic","APP_TYPE");
export default {
  name: 'BasicApp',
