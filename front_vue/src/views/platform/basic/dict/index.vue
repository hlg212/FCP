<template>
  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="编码" prop="code" sortable align="center" width="180" >
        <template slot-scope="{row}">
          <span>{{ row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="值" prop="val" align="center" width="120" >
        <template slot-scope="{row}">
          <span>{{ row.val }}</span>
        </template>
      </el-table-column>
      <el-table-column label="排序号" prop="sortNum" align="center" width="80" >
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="编码" prop="code">
          <el-input :disabled='temp.disabled' v-model="temp.code" placeholder="请输入编码,同级别唯一" />
        </el-form-item>
        <el-form-item label="值" prop="val">
          <el-input :disabled='temp.disabled' v-model="temp.val" placeholder="请输入,值"/>
        </el-form-item>
...
<script>
import { findApps,findTree, getById, save, update,exportPage,importSave, deleteById } from '@/api/basic/dict'
