<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.qco.codeLike" placeholder="机构编码" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="机构编码" prop="code" sortable align="center" width="120" >
        <template slot-scope="{row}">
          <span>{{ row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="扩展字段1" width="100px" align="center">
        <template slot-scope="{row}">
          <span class="link-type">{{ row.ext1 }}</span>
        </template>
      </el-table-column>
      <el-table-column label="扩展字段2" prop="ext2" align="center" width="150" >
        <template slot-scope="{row}">
          <span>{{ row.ext2 }}</span>
        </template>
      </el-table-column>
      <el-table-column label="扩展字段3" prop="ext3"  align="center" width="150" >
        <template slot-scope="{row}">
          <span>{{ row.ext3 }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="机构编码" prop="code">
          <el-input :disabled='temp.disabled' v-model="temp.code" placeholder="输入机构编码" />
        </el-form-item>
        <el-form-item label="扩展字段1" prop="ext1">
           <el-input :disabled='temp.disabled' v-model="temp.ext1" placeholder="输入扩展字段1" />
        </el-form-item>
        <el-form-item label="扩展字段2" prop="ext2">
          <el-input :disabled='temp.disabled' v-model="temp.ext2" placeholder="输入扩展字段2"/>
        </el-form-item>
        <el-form-item label="扩展字段3" prop="ext3">
          <el-input :disabled='temp.disabled' v-model="temp.ext3" placeholder="输入扩展字段3"/>
        </el-form-item>
...
<script>
import { findPage, getById, save, update,exportPage,importSave, deleteById } from '@/api/basic/org'
